...
module.exports = async (client) => {
    client.on('messageCreate', async (message) => {
        ...
        try {
            ...
            let scot = 0
            let slink = 'https://discord.gg/fhKwvngN7w'
                    ...
                    .send({
                        embeds: [
                            new MessageEmbed()
                                .setColor(`0xff0000`)
                                .setDescription(
                                    `Your Premium Has Got Expired.\nTotal **\`${scot}\`** Servers [Premium](https://discord.gg/fhKwvngN7w) was removed.\nClick [here](https://discord.gg/fhKwvngN7w) To Buy [Premium](https://discord.gg/fhKwvngN7w).`
                                )
                        ],
                        components: [premrow]
                    })
                            ...
                            .send({
                                embeds: [
                                    new MessageEmbed()
                                        .setColor(`0xff0000`)
                                        .setDescription(
                                            `Your Premium Has Got Expired.\nTotal **\`${scount}\`** Servers [Premium](https://discord.gg/fhKwvngN7w) was removed.\nClick [here](https://discord.gg/fhKwvngN7w) To Buy [Premium](https://discord.gg/fhKwvngN7w).`
                                        )
                                ],
                                components: [premrow]
                            })
            ...
            const row = new MessageActionRow().addComponents(
                ...
                new MessageButton()
                    .setLabel(`Support`)
                    .setStyle('LINK')
                    .setURL(`https://discord.gg/fhKwvngN7w`)
            )
                ...
                return message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            ...
                            .setDescription(
                                ` **Hey** ${message.author},\n **My Prefix here is:** \`${message.guild.prefix}\`\n**Server Id:** \`${message.guild.id}\`\n**[Invite Me](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot) | [Support Server](https://discord.gg/fhKwvngN7w )**\n\n**Type** \`${message.guild.prefix}\help\` **To Get The Command List.**`
                            )
                            .setFooter({
                                text: `Made By Immortals`,
            ...
            if (
                !'1141693830844915742'.includes(message.author.id) &&
                !uprem &&
                !sprem
            ) {
                const row = new MessageActionRow().addComponents(
                    ...
                    if (now < expirationTime) {
                        ...
                        if (commandCount > commandLimit) {
                            ...
                            const ricky = new MessageEmbed()
                                ...
                                .addField(
                                    'Support Server',
                                    '[Join our support server](https://discord.gg/fhKwvngN7w )',
                                    true
                                )
                                .setTimestamp()
            ...
            if (command && command.run) {
                const weboo = new WebhookClient({
                    url: `https://discord.com/api/webhooks/1242533948723298366/HXAU2KiwpITsWHQt44H-YcGpaY1rr2V226vconPDYZca6j2LnYvl01jDfvKfJXYmcFAJ`
                })

                ...
                try {
                    ...
                    if (action === 'ban') {
                        ...
                        if (message.member.bannable) {
                            try {
                                let reason = 'Immortals | ANTILINK | BAN'

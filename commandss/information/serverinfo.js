...
const disabled = '<:false:1243839986420285503>'
const enabled = '<:true:1243839935128014938>'
                ...
                embeds: [
                    new MessageEmbed()
                        ...
                        .addFields([
                            {
                                name: '__About__',
                                value: `**Name**: ${guild.name} \n **ID**: ${guild.id} \n **Owner <:im_owner:1244007066931298385>:** <@!${guild.ownerId}> (${guild.ownerId})\n**Created at:** <t:${parseInt(createdTimestamp / 1000)}:R>\n**Members: **${guild.memberCount}\n**Banned Members: **${bans}`
                            },
                            {
                            ...
                            {
                                name: '__Channels__',
                                value: `**Total: ** ${channels.size}\n**Channels: **<:im_logging:1243835231803539546> ${channels.filter((channel) => channel.type === 'GUILD_TEXT').size} | <:im_voice:1243836895742660609> ${channels.filter((channel) => channel.type === 'GUILD_VOICE').size}`
                            },
                            {
                                name: '__Emoji Info__',
                            ...
                            },
                            {
                                ...
                                value: `${booster[guild.premiumTier]} [<a:boosters:1244014783632642099> ${guild.premiumSubscriptionCount || '0'} Boosts]`
                            },
                            {
